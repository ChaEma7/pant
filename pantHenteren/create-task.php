            ...
            <form method="post" action="backend.php" enctype="multipart/form-data">
                <div class="header-info">
                    ...
                    <section class="emballage"> 
                        ...
                        <div class="number-input">
                            <!-- Return false sættes på funktionen for at der ikke submittes når der bliver trykket på knapperne-->
                ...
                <div class="header-info">
                    ...
                    <div>
                        ...
                        <script>
                            // Ændrer værdien i output ud fra hvad der bliver valgt i input[type='range'] 
                            $('input[type="range"]');
