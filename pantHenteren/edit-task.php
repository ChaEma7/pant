<?php 
    ...
    // Aflæser hvilken opgave der skal redigeres
    ...
    $sql = "SELECT * FROM taskCard WHERE creatorid = '$userID' AND id = '$taskID'";
            ...
            // Gemmer alle attributter i session så de kan bruges som værdier og fremvises
...
<img class="baggrund" src="img/baggrundsbillede.png" alt="baggrundsbillede">
    <main>
        ...
        <!-- Fungere som create-task.php men værdier er indsat ud fra de allerede intastet værdier i opgaven -->
        <section class="backlayer">
            ...
            <form method="post" action="backend.php?taskID=<?php echo $taskID?>" enctype="multipart/form-data">
                ...
                <!-- Er ikke en del af den nuværende løsning, men kan bruges senere
                     <div class="header-info">
                ...
                <div class="header-info">
                    ...
                    <div>
                        <input type="range" id="udbytte" name="udbytte" min="0" max="100" value="<?php echo 100 - $_SESSION['earnings']?>" step="5" oninput="this.nextElementSibling.value = this.value">
                        <div class="udbytte-container">
                            <div class="udbytte-kasse">
                                <p>Dig</p>
                                <div><output class="outputGiver"><?php echo 100 - $earnings?></output>%</div>
                            </div>
                            <div class="udbytte-kasse udbytte-kasse-afhenter">
                                <p>Afhenter</p>
                                <div><output class="outputAfhenter"><?php echo $earnings?></output>%</div>
                            </div>
                        </div>
                        <script>
                            $('input[type="range"]');
